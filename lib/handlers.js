...
// Create new account -- registration/signup
...
/**
 * Everything below this is related to json API handlers.
 */
                                        ...
                                        _data.delete('checks', checkId, function(err) {
                                            ...
                                            if(checksDeleted == checksToDelete) {
                                                if(!deletionErrors) {
                                                    ...
                                                    callback(500, {"Error": "Errors encountered while attempting to delete all of ther user\'s check data"})
                                                }
                                            }
                                        })
                                    })
